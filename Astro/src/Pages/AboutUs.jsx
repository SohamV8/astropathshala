  ...
  return (
    <div>
      ...
      <div className="top-img-about">
        <img src={trycar} className="w-full h-auto object-cover" alt="Car" />
      </div>

      {/* Why Astro Pathshala Section */}
      <div className="whyastro">
        {/* Section: Why Astro Pathshala */}
        <div className="flex flex-col md:flex-row items-center justify-center space-y-8 md:space-y-0 md:space-x-10 p-6 md:p-8">
          {/* Image */}
          <img
            src={Logo}
            alt="Astro Pathshala Logo"
            className="w-full sm:w-2/3 md:w-1/3 h-auto object-contain"
          />
          {/* Text Content */}
          <div className="flex flex-col space-y-6 max-w-full sm:max-w-2xl text-center md:text-left">
        ...
        <div className="flex flex-col md:flex-row-reverse items-center justify-center space-y-8 md:space-y-0 md:space-x-10 p-6 md:p-8">
          {/* Image */}
          <img
            src={main1}
            alt="Sunil Vashist"
